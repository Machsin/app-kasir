    ...
    foreach ($cart->result() as $c) { ?>
        <tr>
            ...
            <td class="text-center" width="160px">
                ...
                <!-- <form action="<?= site_url('sale/cart_del') ?>" method="POST" class="d-inline">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                    <div class="form-row">
                        <label for="barcode_name" class="col-form-label">Kode Barang</label>
                    ...
                    <div class="form-row">
                        <label for="item_discount">Diskon Barang</label>
...
<script>
    ...
    function simpandata() {
        $('#formku').attr("action", "<?= site_url('sale/update') ?>");
        $('#formku').submit();
        calculate()
    }
</script>