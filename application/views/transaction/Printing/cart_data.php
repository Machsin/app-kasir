    ...
    foreach ($cart->result() as $c) { ?>
        <tr>
            ...
            <td class="text-center" width="160px">
                ...
                <a href="<?=base_url('printing/cart_del/'.$c->cart_id)?>" class="btn btn-xs btn-danger" style="color: white;"><i class="fa fa-trash"></i> Delete</a>
                <!-- <form action="<?= site_url('printing/cart_del') ?>" method="POST" class="d-inline">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                    ...
                    <div class="form-row">
                        <label for="item_p">Panjang</label>
                        <input type="number" id="item_p" min="0" name="item_p" class="form-control" step=".1">
                    </div>
                    <div class="form-row">
                        <label for="item_l">Lebar</label>
                        <input type="number" id="item_l" min="0" name="item_l" class="form-control" step=".1">
                    </div>
...
<script>
    ...
    function simpandata() {
        $('#formku').attr("action", "<?= site_url('printing/update') ?>");
        $('#formku').submit();
        calculate()
    }
</script>