     ...
     <div class="box">
         <div class="box-header">
             ...
             <div class="pull-right">
                 <a href="<?= base_url('stock/out/add') ?>" class="btn btn-primary btn-flat">
         ...
         <div class="box-body table-responsive">
             <table class="table table-bordered table-striped" id="table1">
                 ...
                 <tbody>
                     <?php $no = 1;
                        foreach ($stockout->result() as $key => $data) {
                        ?>
                         <tr>
                             ...
                             <td class="text-center" width="160px">
                                 ...
                                 <a href="<?= base_url('stock/out/delete/' . $data->stock_id . '/' . $data->item_id) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah anda yakin')">
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
                 ...
                 <h4 class="modal-title">Detail Stok Barang Keluar</h4>
             </div>
